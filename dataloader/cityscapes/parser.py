...
def image_path_city(root, name):
    print("IMAGE PATCH CITY========ROOT=============",root)
    print("IMAGE PATCH CITY========NAME=============",name)

    a=os.path.join(root, name)
    print('IMAGE PATCH CITY=====================',a)
    return name
...
class cityscapes(Dataset):
    ...
    def __init__(self, root, subset, h, w, means, stds, crop_h=None, crop_w=None):
        ...
        print("cityscapes images root constructor================",self.images_root)
        ...
        print('EXPANDUSER==',os.path.expanduser(self.images_root))
        print('OS WALK = ',os.walk(os.path.expanduser(self.images_root)))
        for dp, dn, fn in os.walk(os.path.expanduser(self.images_root)):
            print('DP==',dp)
            print('DN==',dn)
            print('FN==',fn)
        for a in os.walk(os.path.expanduser(self.images_root)):
            print('A==',a)
        self.filenames.sort()
        ...
        print("FILENAMES_GTF====", self.filenamesGt)
    ...
    def __getitem__(self, index):
        ...
        print("__GETITEM__===IMAGE===========",filename)
        filenameGt = self.filenamesGt[index]
        print("__GETITEM__===MASK===========",filenameGt)
...
class Parser():
    ...
    def __init__(self, img_prop, img_means, img_stds, classes, train, location=None, batch_size=None, crop_prop=None,
                 workers=2):
        ...
        if self.train:
            ...
            # print("LEN of trainloader -----------------",len(self.trainloader))
            self.trainiter = iter(self.trainloader)
            # print(self.trainiter)
            # for a in self.trainiter:
            #     print(a)
